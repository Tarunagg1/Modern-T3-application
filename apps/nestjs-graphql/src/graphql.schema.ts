...
export abstract class IMutation {
    ...
    abstract updateLeague(id?: Nullable<string>, name: string): Nullable<League> | Promise<Nullable<League>>;

    abstract deleteLeague(id?: Nullable<string>): Nullable<Deleted> | Promise<Nullable<Deleted>>;

    abstract create(name: string, type: string, pokedex: string): Nullable<Pokemon> | Promise<Nullable<Pokemon>>;

    abstract update(id: string, name: string, type: string, pokedex: string): Nullable<Pokemon> | Promise<Nullable<Pokemon>>;
